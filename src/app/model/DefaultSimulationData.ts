...
export const ELECTRON = new ParticleType("Electron", 3, vec4.fromValues(1, 1, 0, 0.5), 30, 0.75, 0.1);
export const BOSON = new ParticleType("Boson", 4, vec4.fromValues(0, 1, 0, 0.5), 50, 1, 0);