...
export const PROTON = new ParticleType("Proton", 0, vec4.fromValues(1, 0.75, 0.75, 1), 10, 1, 0);
export const NEUTRON = new ParticleType("Neutron", 1, vec4.fromValues(0, 1, 1, 0.5), 10, 1, 0);
export const ELECTRON = new ParticleType("Yellow", 2, vec4.fromValues(1, 1, 0, 0.5), 10, 1, 0);
